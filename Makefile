...
# 追加目录
INC_DIRS += ./3rdparty/lvgl ./inc /usr/include/freetype2 ./3rdparty/miniaudio
...
LDLIBS = -lgpiod -lm -lpng -ljpeg -lz -lfreetype -ldl -lasound -lavcodec -lavformat -lavutil -lswscale
